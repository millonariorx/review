...
<head>
  ...
  <title>Review Colombia</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="https://www.researchgate.net/profile/Narcis-Bassols-Gardella/publication/310389803/figure/fig7/AS:744790396268545@1554583276806/A-brand-ahead-of-its-time-The-first-logo-for-Colombia-by-David-Consuegra-back-in_Q320.jpg" rel="icon">
          ...
          <div class="col-lg-4">
            <div class="post-entry-1 lg">
              ...
              <div class="d-flex align-items-center author">
                ...
                <div class="name">
                  <h3 class="m-0 p-0">Steven Duarte</h3>
                </div>
              </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="d-lg-flex post-entry-2">
              ...
              <div>
                ...
                <div class="d-flex align-items-center author">
                  ...
                  <div class="name">
                    <h3 class="m-0 p-0">Fernando Rojas</h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-3">
            <div class="post-entry-1 border-bottom">
              ...
              <h2>No te pierdas de las maravillosas cascadas que tiene zapatoca para ofrecerte</h2>
                        <span class="author">Rances Rodriguez</span>
            </div>
            ...
            <div class="d-lg-flex post-entry-2">
              ...
              <div>
                ...
                <div class="d-flex align-items-center author">
                  ...
                  <div class="name">
                    <h3 class="m-0 p-0">nicolas mena</h3>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <div class="copyright">
              © Copyright <strong><span>Review Colombia</span></strong>. All Rights Reserved
            </div>
